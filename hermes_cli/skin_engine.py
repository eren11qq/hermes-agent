...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "SalesAI — AI lead generation assistant",
        # Dark-authored. Professional blue theme for B2B sales.
        "colors": {
        ...
        "branding": {
            "agent_name": "SalesAI",
            "welcome": "你好，我是 SalesAI，你的 AI 漫剧获客助手。输入 /help 查看命令。",
            "goodbye": "明天见！继续找客户去 💼",
            "response_label": " SalesAI ",
            "prompt_symbol": "▸",
            "help_header": "可用命令",
        },
        "tool_prefix": "┊",
